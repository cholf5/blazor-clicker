...
public static class TranslationsEn
{
    public static readonly IReadOnlyDictionary<string, string> Entries = new Dictionary<string, string>
    {
        ...
        // ---- Stats dialog (the modal opened from the masthead 📊 button) ----
        ["ui.statspage.open"] = "Stats",
        ["ui.statspage.title"] = "Statistics",
        ["ui.statspage.section_general"] = "General",
        ["ui.statspage.section_prestige"] = "Prestige",
        ["ui.statspage.section_progress"] = "Progress",
        ["ui.statspage.section_sugar"] = "Sugar lumps",
        ["ui.statspage.section_history"] = "CPS — last 60 seconds",
        ["ui.statspage.section_contribution"] = "Building contribution",
        ["ui.statspage.section_upgrades_owned"] = "Purchased upgrades",
        ["ui.statspage.hero.bank"] = "in bank",
        ["ui.statspage.hero.cps"] = "cookies / second",
        ["ui.statspage.hero.baked_all_time"] = "baked, all-time",
        ["ui.statspage.contribution.item"] = "{0} owned",
        ["ui.statspage.contribution.empty"] = "Buy a building to see contributions.",
        ["ui.statspage.upgrades_empty"] = "No upgrades purchased yet.",
        ["ui.statspage.upgrades_sort_category"] = "Category",
        ["ui.statspage.upgrades_sort_recent"] = "Recent",
        ["ui.statspage.chart.warming"] = "Warming up…",
        ["ui.statspage.row.bank"] = "Cookies in bank",
        ["ui.statspage.row.baked_run"] = "Cookies baked (this run)",
        ["ui.statspage.row.baked_all_time"] = "Cookies baked (all time)",
        ["ui.statspage.row.cps"] = "Cookies per second",
        ["ui.statspage.row.cps_mult"] = "multiplier: {0}%",
        ["ui.statspage.row.click_power"] = "Cookies per click",
        ["ui.statspage.row.clicks"] = "Cookie clicks",
        ["ui.statspage.row.handmade"] = "Hand-made cookies",
        ["ui.statspage.row.golden_clicks"] = "Golden cookies clicked",
        ["ui.statspage.row.golden_combos"] = "Golden cookie combos",
        ["ui.statspage.row.buildings_owned"] = "Buildings owned",
        ["ui.statspage.row.playtime"] = "Time played",
        ["ui.statspage.row.ascensions"] = "Ascensions",
        ["ui.statspage.row.heavenly"] = "{0} heavenly chip{1} (+{2}% CpS)",
        ["ui.statspage.row.upgrades"] = "Upgrades unlocked",
        ["ui.statspage.row.achievements"] = "Achievements unlocked",
        ["ui.statspage.row.milk"] = "Milk",
        ["ui.statspage.row.milk_kitten"] = "(kittens: ×{0} all production)",
        ["ui.statspage.row.progress_ratio"] = "{0}/{1} ({2}%)",
        ["ui.statspage.row.sugar_balance"] = "Unspent sugar lumps",
        ["ui.statspage.row.sugar_levels"] = "Building levels invested",
